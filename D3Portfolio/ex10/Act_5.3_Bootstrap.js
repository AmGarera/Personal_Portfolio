...
function buildColorScalingFunction() {
    ...
    colorScalingFunction = d3.scale.category20c();
...
function displayDonutChart(data) {
    ...
    //Build arc drawing function for State labels outside of the pie
    ...
    //Value labels inside the donut segments
    g.append("text")
        ...
        .text(function (d) {
            return d.data.QuarterlyEstimates;
        });
    //.style("fill", "white");

    //State Labels - Outside the Donut
    g.append("text")
